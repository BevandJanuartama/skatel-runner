...
<head>
    ...
    <style>
        ...
        .footer-shape {
            /* Diperhalus untuk mobile agar tidak terlalu tajam memotong konten */
...
<body class="bg-white font-sans antialiased text-gray-900">
    ...
    <section class="hero-bg min-h-screen flex flex-col justify-center px-6 md:px-24 text-white">
        <div class="max-w-4xl">
            <p class="text-sm md:text-lg font-medium tracking-widest mb-4 uppercase">Pendaftaran Telah Dibuka</p>
            <h1 class="text-4xl md:text-8xl font-black leading-tight mb-6">
                IKASTELBA<br>FESTIVAL<br>RUN 2026
            </h1>
            <p class="text-sm md:text-lg mb-10 max-w-2xl text-gray-200">
                IKASTELBA Festival Run 2026 adalah momen untuk kembali terhubung, mengenang masa di Skatel, dan mempererat persaudaraan antar alumni SMK Telkom Banjarbaru.
            </p>
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="register" class="bg-[#D32F2F] hover:bg-red-700 text-white px-10 py-4 rounded-full font-bold transition duration-300 text-center">
                    DAFTAR SEKARANG
                </a>
                <a href="about" class="border-2 border-white hover:bg-white hover:text-black text-white px-10 py-4 rounded-full font-bold transition duration-300 text-center">
                    Tentang Kami
                </a>
            </div>
        </div>
    ...
    <section class="py-16 md:py-20 px-6 md:px-24 bg-white" x-data="{ activeSlide: 1 }">
        <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            <div class="w-full md:w-1/2 order-2 md:order-1">
                <h2 class="text-5xl md:text-8xl font-black text-[#D32F2F] mb-6 italic uppercase tracking-tighter">RACEPACK</h2>
                <p class="text-gray-600 mb-8 leading-relaxed text-base md:text-lg">
                    Racepack IKASTELBA Festival Run 2026 mencerminkan energi, kebersamaan, dan kebanggaan alumni dengan tema <strong>"Connecting Memories, Inspiring the Future"</strong>.
                </p>
                
                <ul class="space-y-4 mb-10">
                    <li class="flex items-center gap-3 font-bold text-base md:text-lg">
                ...
                <div class="inline-block w-full md:w-auto text-center md:text-left bg-[#D32F2F] text-white px-10 py-4 rounded-2xl font-black text-2xl md:text-3xl italic shadow-lg">
            ...
            <div class="w-full md:w-1/2 order-1 md:order-2 flex items-center justify-center">
                <div class="relative w-full max-w-[686px] aspect-square md:aspect-[13/8] flex items-center justify-center overflow-hidden rounded-2xl bg-gray-50"
